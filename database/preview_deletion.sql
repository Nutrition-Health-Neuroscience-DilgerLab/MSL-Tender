-- SAFE PREVIEW: Show which records would be deleted
-- Run this BEFORE delete_orphaned_records.sql to verify what will be deleted
-- This does NOT delete anything - it only shows you the records
...
-- This will show you EXACTLY which records would be deleted
-- Look at the image_url column - these should match the 78 images that gave 404 errors
-- If you see any records that look good, DO NOT run delete_orphaned_records.sql!
